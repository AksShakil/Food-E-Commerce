...
const Egg = () => {
     ...
     const [showAll, setShowAll] = useState(false);
              ...
              const products = [
                { id: 1, img: egg1, name: "Apple", currency: "$2.71/lb", price: 99.99, have: 12, sold:12 },
                { id: 2, img: egg2, name: "Orange", currency: "$3.20/lb", price: 99.99, have: 12, sold:12 },
                { id: 3, img: egg3, name: "Banana", currency: "$1.50/lb", price: 99.99, have: 12, sold:12 },
                { id: 4, img: egg4, name: "Mango", currency: "$4.00/lb", price: 99.99, have: 12, sold:12 },
                { id: 5, img: egg1, name: "Apple", currency: "$2.71/lb", price: 99.99, have: 12, sold:12 },
                { id: 6, img: egg2, name: "Apple", currency: "$2.71/lb", price: 99.99, have: 12, sold:12 },
                { id: 7, img: egg3, name: "Orange", currency: "$3.20/lb", price: 99.99, have: 12, sold:12 },
                { id: 8, img: egg4, name: "Banana", currency: "$1.50/lb", price: 99.99, have: 12, sold:12 },
                { id: 9, img: egg1, name: "Mango", currency: "$4.00/lb", price: 99.99, have: 12, sold:12 },
                { id: 10, img: egg1, name: "Apple", currency: "$2.71/lb", price: 99.99, have: 12, sold:12 }
    ...
    return (
         <div>
                           ...
                           <div className="flex w-full items-center justify-between mt-7 mb-[30px]">
                             <h2 className="font-bold text-xl w-full">Egg</h2>
